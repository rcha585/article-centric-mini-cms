...
<div class="search-background">
  ...
  <div class="content-wrapper">
      ...
      {#each articles as article (article.id)}
        <li class="article-card">
          ...
          <div class="info">
            ...
            <p class="desc">{article.content.slice(0, 110)}{article.content.length > 110 ? "..." : ""}</p>
            <div class="meta">
    ...
    <div class="pagination">
      <span>{(page-1)*perPage+1} - {Math.min(page*perPage, totalCount)} of {totalCount} results</span>
